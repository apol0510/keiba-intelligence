...
- 🎯 **全レース的中・外れ記録の完全保存**
- 💰 **月額プレミアム**（正規 ¥5,000 → ¥3,980/月・Stripe）＋ 会員継続クラブ（KIリワード / ランク / 継続価格ロック）
...
> 🔴 **請求額の正本は Stripe の Price**。下表は案内用。
> 仕様の正本は [`docs/RENEWAL_2026_08.md`](./docs/RENEWAL_2026_08.md) §6、
> 会員継続制度は [`docs/MEMBERSHIP_REWARDS.md`](./docs/MEMBERSHIP_REWARDS.md)。

| プラン | 価格 | 内容 |
|--------|------|------|
| **未登録（ゲスト）** | ¥0 | 全頭の馬柱・過去走・特徴量・AI短評・AIレース展望・展開予想 |
| **無料会員** | ¥0 | 上記 ＋ 印（◎○▲△） |
| **月額プレミアム**（主導線・Stripe） | 正規 ¥5,000 → **¥3,980/月** | 上記 ＋ AI指数の数値・AI結論・**南関東4場＋中央競馬の馬単買い目** |
| 年払い（銀行振込・控えめ） | **¥39,800/年** | 月額プレミアムと同じ内容 |

**会員クラブ（継続特典）**: プレミアムを継続すると KIリワードが積み上がり、
会員ランク（Bronze / Silver / Gold / Platinum）に応じてプレゼントをお選びいただけます。
契約中は加入時の価格を維持します（継続価格ロック）。
🔴 ランク差はリワード・プレゼント・長期待遇に限定し、**予想の精度・買い目・情報の質に差は付けません**。
🔴 付与ポイント数・ランクの条件・景品の内容は**未確定**（`docs/MEMBERSHIP_REWARDS.md` §7）。

> 🔴 **廃止済み（復活させない）**: 買い切り ¥88,000 / 年払い ¥66,000 / 月払い ¥12,000 系 /
> ライト ¥6,600 / 会場別アクセス（南関のみ・中央のみ）。2026-08-30 の決定。
