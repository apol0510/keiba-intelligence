...
| M10 | TBD-9 / TBD-10 の確定 | **候補整理済み**（`MEMBERSHIP_DATA_MIGRATION.md` §2.4）。決定は仕様所有者 |
...
0. ~~**会員継続制度の未確定事項 TBD-1〜TBD-8**~~（2026-09-01 **確定**。`MEMBERSHIP_REWARDS.md` §7.1）。
   ...
   | TBD-9 | 継続月数の起点 | **候補整理済み**（`MEMBERSHIP_DATA_MIGRATION.md` §2.4・推奨 D）。移行と同時に決定 |
   | TBD-10 | 支払い失敗・停止中の扱い | **候補整理済み**（同 §2.4・推奨 A＝止めない）。移行と同時に決定 |
