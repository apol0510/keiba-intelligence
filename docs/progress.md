...
| M8 | 景品の品目の選定（TBD-3b / TBD-4b） | **未着手**（仕様所有者） |
| M9 | TBD-9 / TBD-10 / TBD-12 の確定 | **未着手**（Airtable 移行と同時） |
| M10 | Airtable スキーマ移行・write 有効化 | **未実施**（高リスク境界・承認必要） |
...
0. ~~**会員継続制度の未確定事項 TBD-1〜TBD-8**~~（2026-09-01 **確定**。`MEMBERSHIP_REWARDS.md` §7.1）。
   ...
   | TBD-9 | 継続月数の起点（初回課金成功日 / 最初の `active`） | Airtable 移行と同時 |
   | TBD-10 | 支払い失敗・停止中の継続月数とポイントの扱い | Airtable 移行と同時 |
