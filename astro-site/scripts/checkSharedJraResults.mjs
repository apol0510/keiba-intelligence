/**
 * checkSharedJraResults.mjs — JRA results の per-venue 存在確認（認証付き / sharedFetch 再利用）
 *
 ...
 *
 * 使い方:
 *   node scripts/checkSharedJraResults.mjs --date 2026-05-08
 *   node scripts/checkSharedJraResults.mjs --date 2026-05-08 --venues TOK,KYO,HAN,NAK,CHU,KOK,NII,FKS,SAP,HKD
 *
 * 直接実行時の stdout（機械可読・2 行のみ。token / response body は出力しない）:
 *   FOUND_CODES=TOK KYO HAN
 *   TOTAL_RACES=36
 *
 * exit code:
 ...
 */
export async function checkSharedJraResults({
