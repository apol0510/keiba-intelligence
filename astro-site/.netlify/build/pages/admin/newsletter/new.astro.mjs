...
const $$New = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "\u65B0\u898F\u914D\u4FE1\u4F5C\u6210", "description": "\u30E1\u30EB\u30DE\u30AC\u914D\u4FE1\u3092\u4F5C\u6210", "data-astro-cid-ytwpffl3": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="admin-newsletter-new" data-astro-cid-ytwpffl3> <div class="container" data-astro-cid-ytwpffl3> <div class="header" data-astro-cid-ytwpffl3> <h1 data-astro-cid-ytwpffl3>新規配信作成</h1> <a href="/admin/newsletter" class="btn btn-secondary" data-astro-cid-ytwpffl3>← 一覧に戻る</a> </div> <form id="create-form" class="create-form card" data-astro-cid-ytwpffl3> <div class="form-group" data-astro-cid-ytwpffl3> <label for="subject" data-astro-cid-ytwpffl3>件名 *</label> <input type="text" id="subject" name="subject" required placeholder="【KEIBA Intelligence】本日の予想配信" class="form-control" data-astro-cid-ytwpffl3> </div> <div class="form-group" data-astro-cid-ytwpffl3> <label for="body_html" data-astro-cid-ytwpffl3>本文（HTML） *</label> <textarea id="body_html" name="body_html" required rows="15" placeholder="<h2>本日の予想</h2>
