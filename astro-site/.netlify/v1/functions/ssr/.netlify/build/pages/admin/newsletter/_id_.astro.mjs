...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "\u914D\u4FE1\u8A73\u7D30", "description": "\u30E1\u30EB\u30DE\u30AC\u914D\u4FE1\u8A73\u7D30\u30FB\u9001\u4FE1", "data-astro-cid-xoipydew": true }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "AuthCheck", $$AuthCheck, { "data-astro-cid-xoipydew": true })} ${maybeRenderHead()}<section class="admin-newsletter-detail" data-astro-cid-xoipydew> <div class="container" data-astro-cid-xoipydew> <div class="header" data-astro-cid-xoipydew> <h1 data-astro-cid-xoipydew>配信詳細</h1> <a href="/admin/newsletter" class="btn btn-secondary" data-astro-cid-xoipydew>← 一覧に戻る</a> </div> <div id="detail-content" class="detail-content" data-astro-cid-xoipydew> <p data-astro-cid-xoipydew>読み込み中...</p> </div> <div id="message" class="message" data-astro-cid-xoipydew></div> </div> </section>  ${renderScript($$result2, "/Users/apolon/Library/Mobile Documents/com~apple~CloudDocs/WorkSpace/keiba-intelligence/astro-site/src/pages/admin/newsletter/[id].astro?astro&type=script&index=0&lang.ts")} ` })}`;
