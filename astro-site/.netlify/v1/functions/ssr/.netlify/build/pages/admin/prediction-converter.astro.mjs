import { c as createAstro, d as createComponent, i as renderComponent, r as renderTemplate, m as maybeRenderHead, j as renderScript, f as addAttribute } from '../../chunks/astro/server_BKC9sGbb.mjs';
import 'piccolore';
...
</button> </div> </div> </details>`))} <!-- 使用方法 --> <div class="card info-card" data-astro-cid-ri35buz5> <h2 data-astro-cid-ri35buz5>使用方法</h2> <ol data-astro-cid-ri35buz5> <li data-astro-cid-ri35buz5><strong data-astro-cid-ri35buz5>pt値の準備:</strong> 外部ツールで全12レース分のpt値を計算</li> <li data-astro-cid-ri35buz5><strong data-astro-cid-ri35buz5>データ入力:</strong> 開催日・競馬場を入力後、全レースデータを===1R===区切りで入力</li> <li data-astro-cid-ri35buz5><strong data-astro-cid-ri35buz5>生成実行:</strong> 「全レース生成」ボタンでJSON生成</li> <li data-astro-cid-ri35buz5><strong data-astro-cid-ri35buz5>JSON保存:</strong> 全レース統合JSONをコピーして予想データファイルに保存</li> <li data-astro-cid-ri35buz5><strong data-astro-cid-ri35buz5>Git管理:</strong> 変更をコミット・プッシュして自動デプロイ</li> </ol> <h3 data-astro-cid-ri35buz5>入力フォーマット例</h3> <pre class="format-example" data-astro-cid-ri35buz5>===1R===
1,マコスペシャル,90.5
2,クロチャンプ,86.2
3,ケイバスター,82.0
4,ナンカンキング,77.3
