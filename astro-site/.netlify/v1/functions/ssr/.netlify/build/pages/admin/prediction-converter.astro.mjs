...
pt一覧をコピー
</button> </div> <!-- 買い目表示 --> <div class="betting-lines" data-astro-cid-ri35buz5> <h3 data-astro-cid-ri35buz5>買い目（馬単）2段構成</h3> ${Array.isArray(result.bettingLines) ? result.bettingLines.map((line, index) => renderTemplate`<div class="betting-display" data-astro-cid-ri35buz5>${line}</div>`) : renderTemplate`<div class="betting-display" data-astro-cid-ri35buz5>${result.bettingLines}</div>`} </div> <!-- 役割別馬一覧（元データ風表示） --> <div class="horses-list" data-astro-cid-ri35buz5> <h3 data-astro-cid-ri35buz5>役割別馬一覧</h3>  ${result.horses.filter((h) => h.role === "\u672C\u547D").map((horse) => renderTemplate`<div class="horse-item honmei" data-astro-cid-ri35buz5> <div class="horse-header" data-astro-cid-ri35buz5> <span class="role-symbol" data-astro-cid-ri35buz5>◎</span> <span class="horse-number" data-astro-cid-ri35buz5>${horse.horseNumber}</span> <span class="horse-name" data-astro-cid-ri35buz5>${horse.horseName}</span> <span class="role-label" data-astro-cid-ri35buz5>本命</span> </div> <div class="horse-score" data-astro-cid-ri35buz5>累積スコア: <strong data-astro-cid-ri35buz5>${horse.pt}pt</strong></div> </div>`)}  ${result.horses.filter((h) => h.role === "\u5BFE\u6297").map((horse) => renderTemplate`<div class="horse-item taikou" data-astro-cid-ri35buz5> <div class="horse-header" data-astro-cid-ri35buz5> <span class="role-symbol" data-astro-cid-ri35buz5>○</span> <span class="horse-number" data-astro-cid-ri35buz5>${horse.horseNumber}</span> <span class="horse-name" data-astro-cid-ri35buz5>${horse.horseName}</span> <span class="role-label" data-astro-cid-ri35buz5>対抗</span> </div> <div class="horse-score" data-astro-cid-ri35buz5>累積スコア: <strong data-astro-cid-ri35buz5>${horse.pt}pt</strong></div> </div>`)}  ${result.horses.filter((h) => h.role === "\u5358\u7A74").map((horse) => renderTemplate`<div class="horse-item tanana" data-astro-cid-ri35buz5> <div class="horse-header" data-astro-cid-ri35buz5> <span class="role-symbol" data-astro-cid-ri35buz5>▲</span> <span class="horse-number" data-astro-cid-ri35buz5>${horse.horseNumber}</span> <span class="horse-name" data-astro-cid-ri35buz5>${horse.horseName}</span> <span class="role-label" data-astro-cid-ri35buz5>単穴</span> </div> <div class="horse-score" data-astro-cid-ri35buz5>累積スコア: <strong data-astro-cid-ri35buz5>${horse.pt}pt</strong></div> </div>`)}  ${result.horses.filter((h) => h.role === "\u9023\u4E0B").length > 0 && renderTemplate`<div class="horse-group" data-astro-cid-ri35buz5> <div class="group-header" data-astro-cid-ri35buz5>△ 連下候補馬</div> <div class="group-content" data-astro-cid-ri35buz5> ${result.horses.filter((h) => h.role === "\u9023\u4E0B").map((horse, index, arr) => renderTemplate`<span class="horse-short" data-astro-cid-ri35buz5> ${horse.horseNumber} ${horse.horseName} (${horse.pt}pt)${index < arr.length - 1 ? ", " : ""} </span>`)} </div> </div>`}  ${result.horses.filter((h) => h.role === "\u6291\u3048").length > 0 && renderTemplate`<div class="horse-group osae" data-astro-cid-ri35buz5> <div class="group-header" data-astro-cid-ri35buz5>× 抑え候補馬</div> <div class="group-content" data-astro-cid-ri35buz5> ${result.horses.filter((h) => h.role === "\u6291\u3048").map((horse, index, arr) => renderTemplate`<span class="horse-short" data-astro-cid-ri35buz5> ${horse.horseNumber} ${horse.horseName} (${horse.pt}pt)${index < arr.length - 1 ? ", " : ""} </span>`)} </div> </div>`} </div> <!-- JSON出力 --> <div class="json-output" data-astro-cid-ri35buz5> <h3 data-astro-cid-ri35buz5>JSON出力（予想ページ用）</h3> <textarea readonly rows="20" class="json-textarea" data-astro-cid-ri35buz5>${result.json}</textarea> <button type="button" class="btn btn-secondary mt-2" onclick="navigator.clipboard.writeText(this.previousElementSibling.value).then(() => alert('JSONをコピーしました！'))" data-astro-cid-ri35buz5>
JSONをコピー
